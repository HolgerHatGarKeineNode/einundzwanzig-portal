...
class UpdateMeetupTool extends Tool
{
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'nostr_publishing_enabled' => $schema->boolean()->description('Meetup und Termine automatisch als NIP-52-Kalender-Events (kind 31924/31923) auf Nostr veröffentlichen. Standard: an (seit 2026-09-17).'),
        ];
    }
}
